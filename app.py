...
with tab3:
    ...
    st.write("""
        The updated performance metrics of the webtool are provided below.
        These metrics represent evaluation on the latest integrated dataset.
    """)

    # ------------------------------
    # 1️⃣ Updated Model Metrics
    # ------------------------------
    st.subheader("1. Validation with Test Set Containing Decoys")

    new_data = {
        "Model": [
            "Stage 1 - RF", "Stage 1 - ET", "Stage 1 - Consensus",
            "Stage 2 - RF", "Stage 2 - ET", "Stage 2 - Consensus",
            "Overall Final Prediction (2-Stage)"
        ],
        "Accuracy": [
            0.563841808, 0.545762712, 0.754048964,
            0.302876481, 0.395939086, 0.446700508,
            0.809039548
        ],
        "Balanced_Accuracy": [
            0.459878437, 0.443027186, 0.501449727,
            0.388712543, 0.423848596, 0.452596275,
            0.602494993
        ],
        "Precision": [
            0.759791716, 0.754996049, 0.762083320,
            0.254439880, 0.288910291, 0.305681801,
            0.837543135
        ],
        "Recall": [
            0.563841808, 0.545762712, 0.754048964,
        ...
        "F1_Score": [
            0.622104025, 0.608437746, 0.748732530,
            0.230673524, 0.323496620, 0.361502094,
            0.821442549
        ],
        "Sensitivity_Active": [
            0.727272727, 0.696969697, 0.595959596,
            0.915254237, 0.762711864, 0.728813559,
            0.434343434
        ],
        "Sensitivity_HighlyActive": [
            0.0, 0.0, 0.0,
            0.250883392, 0.508833922, 0.628975265,
            0.464751958
        ],
        "Sensitivity_Inactive": [
            0.652362584, 0.632111861, 0.908389585,
            0.0, 0.0, 0.0,
            0.908389585
        ],
        "ROC_AUC": [
            0.728864175, 0.715153655, 0.814547568,
            0.510117789, 0.531448203, 0.539942616,
            0.840911413
        ]
    }
    ...
    # ------------------------------
    # 2️⃣ PAINS Dataset Summary
    # ------------------------------
    st.subheader("2. Classification Results for PAINS Dataset")
